...
export function EventCalendarViews({
    ...
    return (
      ...
      ----------------------------------------------------------------------------------------- */
            ...
            rowEventClass={(info) =>
                cn(
                    "mb-px border-y",
                    info.isStart
                        ? "border-s rounded-s-sm"
                        : !info.isNarrow && "ms-2",
                    info.isEnd
                        ? "border-e rounded-e-sm"
                        : !info.isNarrow && "me-2",
                )
            }
      ...
      ----------------------------------------------------------------------------------------- */
            ...
            slotLaneClass={(info) =>
                cn("border", info.isMinor && "border-dotted")
            }
            /* List Day
      ----------------------------------------------------------------------------------------- */
...
function filledRightTriangle(className?: string) {
    return (
        ...
        >
            <polygon
                points="0,0 66,0 800,1100 66,2200 0,2200"
                fill="currentColor"
            />
        </svg>
    );
